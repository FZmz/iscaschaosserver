...
@Slf4j
@Component
public class P95LatencyMetricStrategy implements IMetricItemStrategy {

    @Override
    public String getMetricName() {
        return "Average P95 Latency (ms)";
    }

    @Override
    public Object computeMetric(JsonNode rootNode) {
        log.info("开始计算 P95 延迟");
        ...
        for (JsonNode series : latencyData) {
            ...
            if ("p95".equalsIgnoreCase(name)) {
                ...
                log.info("成功计算 P95 延迟: 平均值={}ms", formattedAverage);
                return formattedAverage;
            }
        }

        log.warn("未找到 P95 数据系列");
        return 0.0;
    }
