...
@Slf4j
@Component
public class P75LatencyMetricStrategy implements IMetricItemStrategy {


    @Override
    public String getMetricName() {
        return "Average P75 Latency (ms)";
    }


    @Override
    public Object computeMetric(JsonNode rootNode) {
        log.info("开始计算 P75 延迟");
        ...
        for (JsonNode series : latencyData) {
            ...
            if ("p75".equalsIgnoreCase(name)) {
                ...
                log.info("成功计算 P75 延迟: 平均值={}ms", formattedAverage);
                return formattedAverage;
            }
        }

        log.warn("未找到 P75 数据系列");
        return 0.0;
    }
