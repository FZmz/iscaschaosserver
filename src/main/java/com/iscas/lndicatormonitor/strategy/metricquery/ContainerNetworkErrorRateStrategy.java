...
public class ContainerNetworkErrorRateStrategy implements MetricQueryStrategy {
    ...
    public String getQuery(String metricName, Map<String, String> params) {
        ...
        queryBuilder.append(" + ");
        queryBuilder.append("rate(container_network_receive_errors_total");
        PrometheusUtil.appendLabelSelectors(queryBuilder, params);
        queryBuilder.append("[5m])");
        queryBuilder.append(") / ");
        queryBuilder.append("(");
        ...
        queryBuilder.append("[5m])");
        queryBuilder.append(" + ");
        queryBuilder.append("rate(container_network_receive_packets_total");
        PrometheusUtil.appendLabelSelectors(queryBuilder, params);
        queryBuilder.append("[5m])");
