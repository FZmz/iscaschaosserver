...
@RestController
@RequestMapping("PrometheusIndexAn")
public class PrometheusIndexAnController {

    @Autowired
    private PrometheusIndexAnService prometheusIndexAnService;
    ...
    public Result<Object> getPrometheusIndex(PrometheusIndex prometheusIndex) {
        try {
            return Result.success(prometheusIndexAnService.getPrometheusIndex(prometheusIndex), "查询成功");
        } catch (Exception e) {
    ...
    public Result<Object> getNodeIndex(PrometheusIndex prometheusIndex) {
        try {
            return Result.success(prometheusIndexAnService.getNodeIndex(prometheusIndex), "查询成功");
        } catch (Exception e) {
            return Result.error("50000","请稍后查询......");
        }
    }
