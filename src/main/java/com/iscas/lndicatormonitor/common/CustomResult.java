...
public class CustomResult {
    ...
    public static CustomResult ok() {
        return new CustomResult(20000, "success",null);
    }

    public static CustomResult fail(String msg) {
        return new CustomResult(50000, msg, null);
    }
    public static CustomResult fail(String msg, Object data) {
        return new CustomResult(50000, msg, data);
    }
