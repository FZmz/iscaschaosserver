...
@Component
public class PrometheusNonNetworkProcessor {

    private static final Logger log = LoggerFactory.getLogger(PrometheusNonNetworkProcessor.class);
    ...
    public Object process(PrometheusProcessorDTO dto) {
        ...
        try {
            ...
            log.info("IndexName: {}, Params: {}", dto.getIndexName(), params);
